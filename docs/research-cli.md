...
bundle without its analysis, because the next pin waits for it. The report carries
...
another record has replaced it (`analysis_grand_challenge`), and the
